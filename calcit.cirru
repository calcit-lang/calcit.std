...
{} (:package |calcit.std)
  :configs $ {} (:init-fn |calcit.std.test/main!) (:port 6001) (:reload-fn |calcit.std.test/reload!) (:version |0.2.1)
    :modules $ []
  :entries $ {}
  :files $ {}
            ...
            :data $ {}
              ...
              |t $ %{} :Expr (:at 1633182683895) (:by |u0)
                :data $ {}
                  ...
                  |j $ %{} :Leaf (:at 1633182694863) (:by |u0) (:text "|\"%%%% test date")
              |u $ %{} :Expr (:at 1633182723200) (:by |u0)
                :data $ {}
                  |T $ %{} :Leaf (:at 1633182724062) (:by |u0) (:text |println)
